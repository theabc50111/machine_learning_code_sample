...
-- 正在傾印表格  classicmodels.customers 的資料：~122 rows (約數)
...
-- 傾印  表格 classicmodels.employees 結構
...
-- 正在傾印表格  classicmodels.employees 的資料：~23 rows (約數)
...
-- 傾印  表格 classicmodels.offices 結構
...
-- 正在傾印表格  classicmodels.offices 的資料：~7 rows (約數)
DELETE FROM `offices`;
...
-- 傾印  表格 classicmodels.orderdetails 結構
...
-- 正在傾印表格  classicmodels.orderdetails 的資料：~2,996 rows (約數)
...
-- 正在傾印表格  classicmodels.orders 的資料：~326 rows (約數)
DELETE FROM `orders`;
...
-- 傾印  表格 classicmodels.payments 結構
...
-- 正在傾印表格  classicmodels.payments 的資料：~273 rows (約數)
...
-- 傾印  表格 classicmodels.productlines 結構
...
-- 正在傾印表格  classicmodels.productlines 的資料：~7 rows (約數)
...
-- 傾印  表格 classicmodels.products 結構
...
-- 正在傾印表格  classicmodels.products 的資料：~110 rows (約數)
...
-- 傾印  表格 classicmodels.proj55.address_book5 結構
IF NOT EXISTS ;

-- 正在傾印表格  classicmodels.proj55.address_book5 的資料：~16 rows (約數)
DELETE FROM `proj55.address_book5`;
/*!40000 ALTER TABLE `proj55.address_book5` DISABLE KEYS */;
